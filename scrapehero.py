...
def create_url(zipcode, filter):
    ...
    url = 'https://api.proxycrawl.com/?token=TJ04NodQiq_zEJsDCiy4Kw&url='
...
def write_data_to_csv(data):
    ...
    with open("properties-%s.csv" % (zipcode), 'wb') as csvfile:
        fieldnames = ['title', 'address', 'city', 'state', 'postal_code',
...
if __name__ == "__main__":
    ...
    # zipcode = args.zipcode if args.zipcode else '33024'
    # sort = args.sort if args.sort else 'newest'
    zipcode = '33024'
    sort = 'newest'
